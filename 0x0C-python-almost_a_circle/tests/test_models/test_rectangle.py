...
class TestRectangle_instantiation(unittest.TestCase):
    ''' Validating Rectangle class initialization through unit tests'''
    ...
    def test_three_args(self):
        rect_1 = Rectangle(2, 2, 4)
        rect_2 = Rectangle(4, 4, 2)
        self.assertEqual(rect_1.id, rect_2.id - 1)

    def test_four_args(self):
        rect_1 = Rectangle(1, 2, 3, 4)
        rect_2 = Rectangle(4, 3, 2, 1)
        self.assertEqual(rect_1.id, rect_2.id - 1)
...
class TestRectangle_width(unittest.TestCase):
    ''' unittests: verifying Rectangle width initialization behavior'''
...
class TestRectangle_height(unittest.TestCase):
    """ unittests: confirm Rectangle height is set correctly during
                   initialization.
    """
...
class TestRectangle_x(unittest.TestCase):
    """ unittests: verify Rectangle's x-coordinate initialization"""
...
class TestRectangle_y(unittest.TestCase):
    """ unittests: verify Rectangle object's y-coordinate initialization."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """ unittests: verify the sequence in which a Rectangle object's
...
class TestRectangle_area(unittest.TestCase):
    """Unit tests focused on validating the accuracy of the area calculation
...
class TestRectangle_stdout(unittest.TestCase):
    ...
    def test_str_method_print_width_height(self):
        ...
        valid = "[Rectangle] ({}) 0/0 - 4/6\n".format(rect.id)
        self.assertEqual(valid, capture.getvalue())

    def test_str_method_width_height_x(self):
        rect = Rectangle(5, 5, 1)
        valid = "[Rectangle] ({}) 1/0 - 5/5".format(rect.id)
        self.assertEqual(valid, rect.__str__())

    def test_str_method_width_height_x_y(self):
        rect = Rectangle(1, 8, 2, 4)
        valid = "[Rectangle] ({}) 2/4 - 1/8".format(rect.id)
        self.assertEqual(valid, str(rect))
...
class TestRectangle_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        rect = Rectangle(10, 10, 10, 10, 10)
        rect.update(None)
        valid = "[Rectangle] ({}) 10/10 - 10/10".format(rect.id)
        self.assertEqual(valid, str(rect))

    def test_update_args_None_id_and_more(self):
        rect = Rectangle(10, 10, 10, 10, 10)
        rect.update(None, 4, 5, 2)
        valid = "[Rectangle] ({}) 2/10 - 4/5".format(rect.id)
        self.assertEqual(valid, str(rect))
...
class TestRectangle_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        valid = "[Rectangle] ({}) 10/9 - 10/7".format(rect.id)
        self.assertEqual(valid, str(rect))
...
class TestRectangle_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        ...
        valid = {'x': 1, 'y': 9, 'id': 5, 'height': 2, 'width': 10}
        self.assertDictEqual(valid, rect.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        rect_1 = Rectangle(10, 2, 1, 9, 5)
        rect_2 = Rectangle(5, 9, 1, 2, 10)
        rect_2.update(**rect_1.to_dictionary())
