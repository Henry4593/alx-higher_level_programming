...
class TestSquare_instantiation(unittest.TestCase):
    ...
    def test_one_arg(self):
        sqr_1 = Square(10)
        sqr_2 = Square(11)
        self.assertEqual(sqr_1.id, sqr_2.id - 1)
...
class TestSquare_stdout(unittest.TestCase):
    ...
    def test_str_method_size_x(self):
        sqr = Square(5, 5)
        valid = "[Square] ({}) 5/0 - 5".format(sqr.id)
        self.assertEqual(valid, sqr.__str__())

    def test_str_method_size_x_y(self):
        sqr = Square(7, 4, 22)
        valid = "[Square] ({}) 4/22 - 7".format(sqr.id)
        self.assertEqual(valid, str(sqr))
...
class TestSquare_update_args(unittest.TestCase):
    ...
    def test_update_args_None_id(self):
        sqr = Square(10, 10, 10, 10)
        sqr.update(None)
        valid = "[Square] ({}) 10/10 - 10".format(sqr.id)
        self.assertEqual(valid, str(sqr))

    def test_update_args_None_id_and_more(self):
        sqr = Square(10, 10, 10, 10)
        sqr.update(None, 4, 5)
        valid = "[Square] ({}) 5/10 - 4".format(sqr.id)
        self.assertEqual(valid, str(sqr))
...
class TestSquare_update_kwargs(unittest.TestCase):
    ...
    def test_update_kwargs_None_id_and_more(self):
        ...
        valid = "[Square] ({}) 18/10 - 7".format(sqr.id)
        self.assertEqual(valid, str(sqr))
...
class TestSquare_to_dictionary(unittest.TestCase):
    ...
    def test_to_dictionary_output(self):
        sqr = Square(10, 2, 1, 1)
        valid = {'id': 1, 'x': 2, 'size': 10, 'y': 1}
        self.assertDictEqual(valid, sqr.to_dictionary())

    def test_to_dictionary_no_object_changes(self):
        sqr_1 = Square(10, 2, 1, 2)
        sqr_2 = Square(1, 2, 10)
        sqr_2.update(**sqr_1.to_dictionary())
